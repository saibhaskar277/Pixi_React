...
const MENU_ITEMS = [
  {
    index: "01",
    label: "Play",
    action: () => EventBus.emit("CHANGE_SCENE", "GAMEPLAY"),
  },
  {
    index: "02",
    label: "Continue",
  ...
  },
  {
    index: "03",
    label: "Options",
    action: () => EventBus.emit("OPEN_OPTIONS"),
  },
    ...
    <div className="menu-hud">
      <div className="menu-panel">
        ...
        <nav className="menu-nav">
          {MENU_ITEMS.map((item) => (
            <button key={item.index} className="menu-btn" onClick={item.action}>
